...
.method public final prepareForRecognition(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;)I
    ...
    const-string p0, "prepareForRecognition: cannot attach to sound trigger module"
    ...
    const-string v0, "prepareForRecognition: loadSoundModel failed with status: "
...
.method public final queryParameterLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;I)Landroid/hardware/soundtrigger/SoundTrigger$ModelParamRange;
    ...
    const-string p0, "queryParameter: Invalid model id"
    ...
    const-string p2, "queryParameter: Given model is not loaded:"
...
.method public final startRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    const-string p1, "startRecognition requested but not allowed."
    ...
    const-string p1, "sth_start_recognition_not_allowed"
    ...
    const-string v6, "startRecognition failed with "
    ...
    :cond_3
    const-string v2, "startRecognition successful."

    invoke-static {v5, v2}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v2, p0, Lcom/android/server/soundtrigger/SoundTriggerHelper;->mContext:Landroid/content/Context;

    const-string v3, "sth_start_recognition_success"
    ...
    :cond_5
    :goto_1
    const-string p1, "startRecognition: Bad data passed in."
...
.method public stopGenericRecognition(Ljava/util/UUID;Landroid/hardware/soundtrigger/IRecognitionStatusCallback;)I
    ...
    const-string v1, "stopGenericRecognition failed: "
...
.method public final tryStopAndUnloadLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    const-string p1, "stopRecognition failed: "
    ...
    const-string p3, "sth_unloading_stale_model"
    ...
    const-string p1, "unloadSoundModel call failed with "
...
.method public unloadGenericSoundModel(Ljava/util/UUID;)I
    ...
    const-string v4, "unloadGenericSoundModel() call failed with "
    ...
    const-string v3, "unloadGenericSoundModel() force-marking model as unloaded."
...
.method public unloadKeyphraseSoundModel(I)I
    ...
    const-string v4, "unloadKeyphraseSoundModel call failed with "
...
.method public final updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    const-string p1, "startRecognition failed to prepare model for recognition"
