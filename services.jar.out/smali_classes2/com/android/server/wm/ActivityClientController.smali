...
.method static synthetic lambda$getActivityTokenBelow$2(Lcom/android/server/wm/ActivityRecord;)Z
    .locals 1
...
.method public getActivityTokenBelow(Landroid/os/IBinder;)Landroid/os/IBinder;
    ...
    sget-object v6, Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda2;->INSTANCE:Lcom/android/server/wm/ActivityClientController$$ExternalSyntheticLambda2;

    const/4 v7, 0x0

    const/4 v8, 0x1

    invoke-virtual {v5, v6, v3, v7, v8}, Lcom/android/server/wm/Task;->getActivity(Ljava/util/function/Predicate;Lcom/android/server/wm/WindowContainer;ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object v4, v5, Lcom/android/server/wm/ActivityRecord;->appToken:Lcom/android/server/wm/ActivityRecord$Token;

    invoke-virtual {v4}, Lcom/android/server/wm/ActivityRecord$Token;->asBinder()Landroid/os/IBinder;
...
.method public onBackPressedOnTaskRoot(Landroid/os/IBinder;Landroid/app/IRequestFinishCallback;)V
    ...
    invoke-virtual {v3, v9}, Lcom/android/server/wm/ActivityRecord;->isLaunchSourceType(I)Z
    ...
    invoke-static {v8}, Lcom/android/server/wm/ActivityRecord;->isMainIntent(Landroid/content/Intent;)Z
...
.method public overridePendingTransition(Landroid/os/IBinder;Ljava/lang/String;II)V
    ...
    :try_start_1
    invoke-static {p2, v8, v9, v6}, Landroid/window/TransitionInfo$AnimationOptions;->makeCustomAnimOptions(Ljava/lang/String;IIZ)Landroid/window/TransitionInfo$AnimationOptions;

    move-result-object v6

    const/4 v10, 0x0

    invoke-virtual {v5, v6, v10, v10}, Lcom/android/server/wm/TransitionController;->setOverrideAnimation(Landroid/window/TransitionInfo$AnimationOptions;Landroid/os/IRemoteCallback;Landroid/os/IRemoteCallback;)V
