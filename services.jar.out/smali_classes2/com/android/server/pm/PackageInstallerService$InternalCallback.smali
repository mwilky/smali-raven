...
.method public onSessionActiveChanged(Lcom/android/server/pm/PackageInstallerSession;Z)V
    ...
    invoke-static {v0}, Lcom/android/server/pm/PackageInstallerService;->access$200(Lcom/android/server/pm/PackageInstallerService;)Lcom/android/server/pm/PackageInstallerService$Callbacks;
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$500(Lcom/android/server/pm/PackageInstallerService$Callbacks;IIZ)V
...
.method public onSessionBadgingChanged(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$300(Lcom/android/server/pm/PackageInstallerService$Callbacks;II)V

    iget-object v0, p0, Lcom/android/server/pm/PackageInstallerService$InternalCallback;->this$0:Lcom/android/server/pm/PackageInstallerService;

    invoke-static {v0}, Lcom/android/server/pm/PackageInstallerService;->access$400(Lcom/android/server/pm/PackageInstallerService;)Lcom/android/server/pm/utils/RequestThrottle;
...
.method public onSessionProgressChanged(Lcom/android/server/pm/PackageInstallerSession;F)V
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->access$600(Lcom/android/server/pm/PackageInstallerService$Callbacks;IIF)V
...
.method public onStagedSessionChanged(Lcom/android/server/pm/PackageInstallerSession;)V
    ...
    invoke-static {v0}, Lcom/android/server/pm/PackageInstallerService;->access$700(Lcom/android/server/pm/PackageInstallerService;)Z
    ...
    invoke-static {v0}, Lcom/android/server/pm/PackageInstallerService;->access$800(Lcom/android/server/pm/PackageInstallerService;)Lcom/android/server/pm/PackageManagerService;
