...
.method public declared-synchronized recordCheckResult(Lcom/android/server/timezone/CheckToken;Z)V
    ...
    const-string p1, "timezone.PackageTracker"

    const-string p2, "recordCheckResult: Tracking is disabled and no token has been provided. Resetting tracking state."
    ...
    :cond_0
    const-string p2, "timezone.PackageTracker"

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "recordCheckResult: Tracking is disabled and a token "
    ...
    const-string p2, "recordCheckResult: Unexpectedly missing checkToken, resetting storage state."
    ...
    const-string v2, "recordCheckResult: could not update token="
...
.method public declared-synchronized triggerUpdateIfNeeded(Z)V
    ...
    const-string v0, "triggerUpdateIfNeeded: First reliability trigger."
    ...
    const-string v0, "triggerUpdateIfNeeded: checkComplete call is not yet overdue. Not triggering."
    ...
    const-string v0, "triggerUpdateIfNeeded: number of allowed consecutive check failures exceeded. Stopping reliability triggers until next reboot or package update."
    ...
    const-string v0, "triggerUpdateIfNeeded: No reliability check required. Last check was successful."
    ...
    const-string v0, "triggerUpdateIfNeeded: currentInstalledVersions was null"
    ...
    const-string v1, "triggerUpdateIfNeeded: No package status data found. Data check needed."
    ...
    const-string v3, "triggerUpdateIfNeeded: Stored package versions="
    ...
    const-string v3, "triggerUpdateIfNeeded: Stored package versions match currently installed versions, currentInstalledVersions="
    ...
    const-string v0, "triggerUpdateIfNeeded: Prior check succeeded. No need to trigger."
    ...
    const-string v0, "triggerUpdateIfNeeded: Unable to generate check token. Not sending check request."
