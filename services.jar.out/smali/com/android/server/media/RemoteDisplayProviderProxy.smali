...
.method private bind()V
    ...
    iput-boolean v4, p0, Lcom/android/server/media/RemoteDisplayProviderProxy;->mBound:Z
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    new-instance v3, Lcom/android/server/media/RemoteDisplayProviderProxy$Connection;

    invoke-direct {v3, p0, v2}, Lcom/android/server/media/RemoteDisplayProviderProxy$Connection;-><init>(Lcom/android/server/media/RemoteDisplayProviderProxy;Landroid/media/IRemoteDisplayProvider;)V

    invoke-virtual {v3}, Lcom/android/server/media/RemoteDisplayProviderProxy$Connection;->register()Z

    move-result v4

    if-eqz v4, :cond_1

    iput-object v3, p0, Lcom/android/server/media/RemoteDisplayProviderProxy;->mActiveConnection:Lcom/android/server/media/RemoteDisplayProviderProxy$Connection;
