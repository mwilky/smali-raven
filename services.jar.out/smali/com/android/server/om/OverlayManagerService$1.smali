...
.method public final executeAllRequests(Landroid/content/om/OverlayManagerTransaction;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/om/OverlayManagerService$1;->executeRequest(Landroid/content/om/OverlayManagerTransaction$Request;)Ljava/util/Set;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/android/internal/util/CollectionUtils;->addAll(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/Set;
    ...
    invoke-static {p0, v1}, Lcom/android/server/om/OverlayManagerService;->-$$Nest$mupdateTargetPackagesLocked(Lcom/android/server/om/OverlayManagerService;Ljava/util/Set;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final executeRequest(Landroid/content/om/OverlayManagerTransaction$Request;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v0, v1, v5}, Lcom/android/server/om/OverlayManagerService$1;->enforceActor(Landroid/content/om/OverlayIdentifier;Ljava/lang/String;I)V
    ...
    invoke-static {v7}, Lcom/android/server/om/OverlayManagerService;->-$$Nest$fgetmPackageManager(Lcom/android/server/om/OverlayManagerService;)Lcom/android/server/om/OverlayManagerService$PackageManagerHelperImpl;

    move-result-object v7

    invoke-virtual {v7, v0}, Lcom/android/server/om/OverlayManagerService$PackageManagerHelperImpl;->getPackagesForUid(I)[Ljava/lang/String;
    ...
    :try_start_0
    iget v7, p1, Landroid/content/om/OverlayManagerTransaction$Request;->type:I
    ...
    const-string/jumbo v3, "unsupported request: "
    ...
    const-string/jumbo v2, "no fabricated overlay attached to request"
    ...
    invoke-virtual {v4, v6, v3, v5}, Lcom/android/server/om/OverlayManagerServiceImpl;->setEnabled(Landroid/content/om/OverlayIdentifier;ZI)Ljava/util/Set;
    ...
    invoke-static {v2, p0}, Lcom/android/internal/util/CollectionUtils;->addAll(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/Set;
