...
.method public addAutomaticZenRule(Ljava/lang/String;Landroid/app/AutomaticZenRule;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/notification/ZenModeHelper;->isSystemRule(Landroid/app/AutomaticZenRule;)Z
...
.method public applyRestrictions()V
    ...
    :goto_e
    sget-object v11, Landroid/media/AudioAttributes;->SDK_USAGES:[I
    ...
    invoke-virtual {v0, v5, v4, v14}, Lcom/android/server/notification/ZenModeHelper;->applyRestrictions(ZZI)V
    ...
    :goto_11
    invoke-virtual {v0, v5, v15, v14}, Lcom/android/server/notification/ZenModeHelper;->applyRestrictions(ZZI)V
    ...
    invoke-virtual {v0, v5, v4, v14, v15}, Lcom/android/server/notification/ZenModeHelper;->applyRestrictions(ZZII)V

    const/4 v4, 0x0

    invoke-virtual {v0, v5, v4, v14, v8}, Lcom/android/server/notification/ZenModeHelper;->applyRestrictions(ZZII)V
    ...
    invoke-virtual {v0, v5, v7, v14}, Lcom/android/server/notification/ZenModeHelper;->applyRestrictions(ZZI)V
...
.method public final isSystemRule(Landroid/app/AutomaticZenRule;)Z
    .locals 0
...
.method public final populateZenRule(Ljava/lang/String;Landroid/app/AutomaticZenRule;Landroid/service/notification/ZenModeConfig$ZenRule;Z)V
    ...
    invoke-static {p0, v0}, Landroid/app/NotificationManager;->zenModeFromInterruptionFilter(II)I
    ...
    iput-wide v1, p3, Landroid/service/notification/ZenModeConfig$ZenRule;->creationTime:J
    ...
    iput-boolean v0, p3, Landroid/service/notification/ZenModeConfig$ZenRule;->snoozing:Z
...
.method public readXml(Landroid/util/TypedXmlPullParser;ZI)V
    ...
    invoke-virtual {v2, v3}, Landroid/util/ArrayMap;->containsAll(Ljava/util/Collection;)Z
    ...
    iput-boolean v6, v9, Landroid/service/notification/ZenModeConfig$ZenRule;->snoozing:Z

    iput-object v1, v9, Landroid/service/notification/ZenModeConfig$ZenRule;->condition:Landroid/service/notification/Condition;

    iput-wide v3, v9, Landroid/service/notification/ZenModeConfig$ZenRule;->creationTime:J
    ...
    invoke-static {p2, v2, v7, p3}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
