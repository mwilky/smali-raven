...
.method public synthetic constructor <init>(Lcom/android/server/autofill/RemoteFillService;Ljava/lang/Throwable;Landroid/service/autofill/FillRequest;Landroid/service/autofill/FillResponse;Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    iput-object p2, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$1:Ljava/lang/Throwable;

    iput-object p3, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$2:Landroid/service/autofill/FillRequest;

    iput-object p4, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$3:Landroid/service/autofill/FillResponse;

    iput-object p5, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$4:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final run()V
    ...
    iget-object v1, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$1:Ljava/lang/Throwable;

    iget-object v2, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$2:Landroid/service/autofill/FillRequest;

    iget-object v3, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$3:Landroid/service/autofill/FillResponse;

    iget-object v4, p0, Lcom/android/server/autofill/RemoteFillService$$ExternalSyntheticLambda4;->f$4:Ljava/util/concurrent/atomic/AtomicReference;
