...
.method private static dabConfigFromHal(Ljava/util/List;)Ljava/util/Map;
    ...
    sget-object v1, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda3;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda3;

    sget-object v2, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda4;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda4;
...
.method static programFilterToHal(Landroid/hardware/radio/ProgramList$Filter;)Landroid/hardware/broadcastradio/V2_0/ProgramFilter;
    ...
    new-instance v3, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda2;

    invoke-direct {v3, v2}, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda2;-><init>(Ljava/util/ArrayList;)V
    ...
    invoke-direct {v2, v0}, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda0;-><init>(Landroid/hardware/broadcastradio/V2_0/ProgramFilter;)V
...
.method static programInfoFromHal(Landroid/hardware/broadcastradio/V2_0/ProgramInfo;)Landroid/hardware/radio/RadioManager$ProgramInfo;
    ...
    sget-object v1, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda5;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda5;
...
.method static programListChunkFromHal(Landroid/hardware/broadcastradio/V2_0/ProgramListChunk;)Landroid/hardware/radio/ProgramList$Chunk;
    ...
    sget-object v1, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda8;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda8;
    ...
    sget-object v2, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda6;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda6;
...
.method static programSelectorFromHal(Landroid/hardware/broadcastradio/V2_0/ProgramSelector;)Landroid/hardware/radio/ProgramSelector;
    ...
    sget-object v2, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda7;

    invoke-interface {v0, v2}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v0

    sget-object v2, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda10;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda10;

    invoke-interface {v0, v2}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v0

    sget-object v2, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda11;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda11;
...
.method static programSelectorToHal(Landroid/hardware/radio/ProgramSelector;)Landroid/hardware/broadcastradio/V2_0/ProgramSelector;
    ...
    sget-object v2, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda9;->INSTANCE:Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda9;
    ...
    new-instance v3, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda1;

    invoke-direct {v3, v2}, Lcom/android/server/broadcastradio/hal2/Convert$$ExternalSyntheticLambda1;-><init>(Ljava/util/ArrayList;)V
...
.method static propertiesFromHal(ILjava/lang/String;Landroid/hardware/broadcastradio/V2_0/Properties;Landroid/hardware/broadcastradio/V2_0/AmFmRegionConfig;Ljava/util/List;)Landroid/hardware/radio/RadioManager$ModuleProperties;
    ...
    sget-object v4, Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/server/audio/AudioService$$ExternalSyntheticLambda7;
