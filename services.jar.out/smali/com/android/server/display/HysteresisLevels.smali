...
# instance fields
.field public final mBrighteningThresholds:[F

.field public final mDarkeningThresholds:[F

.field public final mMinBrightening:F

.field public final mMinDarkening:F

.field public final mThresholdLevels:[F


# direct methods
.method public constructor <init>([I[I[IFF)V
    .locals 2
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/display/HysteresisLevels;->setArrayFormat([IF)[F

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/display/HysteresisLevels;->mBrighteningThresholds:[F

    invoke-virtual {p0, p2, v0}, Lcom/android/server/display/HysteresisLevels;->setArrayFormat([IF)[F
    ...
    invoke-virtual {p0, p3, p1}, Lcom/android/server/display/HysteresisLevels;->setArrayFormat([IF)[F
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object p0, p0, Lcom/android/server/display/HysteresisLevels;->mThresholdLevels:[F
...
.method public getBrighteningThreshold(F)F
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/display/HysteresisLevels;->getReferenceLevel(F[F)F
    ...
    iget p0, p0, Lcom/android/server/display/HysteresisLevels;->mMinBrightening:F
...
.method public getDarkeningThreshold(F)F
    ...
    iget p0, p0, Lcom/android/server/display/HysteresisLevels;->mMinDarkening:F
...
.method public final getReferenceLevel(F[F)F
    .locals 3
...
.method public final setArrayFormat([IF)[F
    .locals 3
