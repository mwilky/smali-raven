...
.field private static final MSG_I_SCO_AUDIO_STATE_CHANGED:I = 0x2c
...
.field private static final MSG_L_SET_COMMUNICATION_ROUTE_FOR_CLIENT:I = 0x2a
...
.method static synthetic access$1100(Lcom/android/server/audio/AudioDeviceBroker;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioDeviceBroker;->onUpdateCommunicationRouteClient(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$1200(Lcom/android/server/audio/AudioDeviceBroker;Lcom/android/server/audio/AudioDeviceBroker$CommunicationRouteClient;)V
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/audio/AudioDeviceBroker;)I
    .locals 1
...
.method static synthetic access$1400(Lcom/android/server/audio/AudioDeviceBroker;Landroid/media/AudioDeviceAttributes;)V
    .locals 0
...
.method static synthetic access$1500(Lcom/android/server/audio/AudioDeviceBroker;I)V
    .locals 0
...
.method static synthetic access$1700(Lcom/android/server/audio/AudioDeviceBroker;III)V
    .locals 0
...
.method static synthetic access$1900(Lcom/android/server/audio/AudioDeviceBroker;)Landroid/os/PowerManager$WakeLock;
    .locals 1
...
.method private onCommunicationRouteClientDied(Lcom/android/server/audio/AudioDeviceBroker$CommunicationRouteClient;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/audio/AudioDeviceBroker;->onUpdateCommunicationRouteClient(Ljava/lang/String;)V
...
.method private onUpdateCommunicationRoute(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/audio/AudioDeviceBroker;->removePreferredDevicesForStrategySync(I)I
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/server/audio/AudioDeviceBroker;->setPreferredDevicesForStrategySync(ILjava/util/List;)I
...
.method private onUpdateCommunicationRouteClient(Ljava/lang/String;)V
    .locals 7
...
.method postScoAudioStateChanged(I)V
    .locals 2
...
.method postSetCommunicationRouteForClient(Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;)V
    .locals 2
...
.method postUpdateCommunicationRouteClient(Ljava/lang/String;)V
    .locals 2
...
.method setCommunicationDevice(Landroid/os/IBinder;ILandroid/media/AudioDeviceInfo;Ljava/lang/String;)Z
    ...
    :goto_0
    :try_start_3
    new-instance v9, Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/audio/AudioDeviceBroker;->postSetCommunicationRouteForClient(Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;)V
...
.method setSpeakerphoneOn(Landroid/os/IBinder;IZLjava/lang/String;)V
    ...
    :cond_1
    :goto_0
    new-instance v3, Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;-><init>(Landroid/os/IBinder;ILandroid/media/AudioDeviceAttributes;ILjava/lang/String;)V

    invoke-virtual {p0, v3}, Lcom/android/server/audio/AudioDeviceBroker;->postSetCommunicationRouteForClient(Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;)V
...
.method stopBluetoothScoForClient(Landroid/os/IBinder;ILjava/lang/String;)V
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/audio/AudioDeviceBroker$CommunicationClientInfo;-><init>(Landroid/os/IBinder;ILandroid/media/AudioDeviceAttributes;ILjava/lang/String;)V
