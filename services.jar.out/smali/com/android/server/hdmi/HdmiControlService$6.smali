...
.method constructor <init>(Lcom/android/server/hdmi/HdmiControlService;Lcom/android/server/hdmi/HdmiControlService$HdmiControlStatusChangeListenerRecord;Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;)V
    ...
    iput-object p2, p0, Lcom/android/server/hdmi/HdmiControlService$6;->val$record:Lcom/android/server/hdmi/HdmiControlService$HdmiControlStatusChangeListenerRecord;

    iput-object p3, p0, Lcom/android/server/hdmi/HdmiControlService$6;->val$listener:Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;
...
.method public run()V
    ...
    iget-object v2, p0, Lcom/android/server/hdmi/HdmiControlService$6;->val$record:Lcom/android/server/hdmi/HdmiControlService$HdmiControlStatusChangeListenerRecord;
    ...
    iget-object v2, p0, Lcom/android/server/hdmi/HdmiControlService$6;->val$listener:Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;

    invoke-static {v0}, Lcom/android/server/hdmi/HdmiControlService;->access$5600(Lcom/android/server/hdmi/HdmiControlService;)I

    move-result v3

    invoke-static {v0, v2, v3}, Lcom/android/server/hdmi/HdmiControlService;->access$5700(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;I)V
