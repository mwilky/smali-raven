...
.method constructor <init>(ILandroid/content/Context;Lcom/android/server/backup/transport/TransportStats;Landroid/content/Intent;Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;Landroid/os/Handler;)V
    ...
    new-instance v1, Lcom/android/server/backup/transport/TransportClient$TransportConnection;

    const/4 v2, 0x0

    invoke-direct {v1, p2, p0, v2}, Lcom/android/server/backup/transport/TransportClient$TransportConnection;-><init>(Landroid/content/Context;Lcom/android/server/backup/transport/TransportClient;Lcom/android/server/backup/transport/TransportClient$1;)V

    iput-object v1, p0, Lcom/android/server/backup/transport/TransportClient;->mConnection:Landroid/content/ServiceConnection;
    ...
    iput-object v2, p0, Lcom/android/server/backup/transport/TransportClient;->mPrefixForLog:Ljava/lang/String;
...
.method private notifyListener(Lcom/android/server/backup/transport/TransportConnectionListener;Lcom/android/internal/backup/IBackupTransport;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/android/server/backup/transport/TransportClient$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0, p1, p2}, Lcom/android/server/backup/transport/TransportClient$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/backup/transport/TransportClient;Lcom/android/server/backup/transport/TransportConnectionListener;Lcom/android/internal/backup/IBackupTransport;)V
...
.method public connect(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    new-instance v4, Lcom/android/server/backup/transport/TransportClient$$ExternalSyntheticLambda0;

    invoke-direct {v4, v3}, Lcom/android/server/backup/transport/TransportClient$$ExternalSyntheticLambda0;-><init>(Ljava/util/concurrent/CompletableFuture;)V
