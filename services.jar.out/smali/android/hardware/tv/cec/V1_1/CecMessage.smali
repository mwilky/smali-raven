...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/tv/cec/V1_1/CecMessage;

    invoke-direct {v5}, Landroid/hardware/tv/cec/V1_1/CecMessage;-><init>()V

    mul-int/lit8 v6, v4, 0x18

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/tv/cec/V1_1/CecMessage;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/tv/cec/V1_1/CecMessage;

    mul-int/lit8 v5, v3, 0x18

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/tv/cec/V1_1/CecMessage;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/tv/cec/V1_1/CecMessage;

    iget v3, p0, Landroid/hardware/tv/cec/V1_1/CecMessage;->initiator:I

    iget v4, v2, Landroid/hardware/tv/cec/V1_1/CecMessage;->initiator:I
    ...
    :cond_3
    iget v3, p0, Landroid/hardware/tv/cec/V1_1/CecMessage;->destination:I

    iget v4, v2, Landroid/hardware/tv/cec/V1_1/CecMessage;->destination:I
    ...
    :cond_4
    iget-object v3, p0, Landroid/hardware/tv/cec/V1_1/CecMessage;->body:Ljava/util/ArrayList;

    iget-object v4, v2, Landroid/hardware/tv/cec/V1_1/CecMessage;->body:Ljava/util/ArrayList;
...
.method public final hashCode()I
    ...
    iget-object v1, p0, Landroid/hardware/tv/cec/V1_1/CecMessage;->body:Ljava/util/ArrayList;
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object v9, p0, Landroid/hardware/tv/cec/V1_1/CecMessage;->body:Ljava/util/ArrayList;
