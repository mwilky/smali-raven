...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/health/V2_1/HealthInfo;

    invoke-direct {v5}, Landroid/hardware/health/V2_1/HealthInfo;-><init>()V

    mul-int/lit16 v6, v4, 0x88

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/health/V2_1/HealthInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/health/V2_1/HealthInfo;

    mul-int/lit16 v5, v3, 0x88

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/health/V2_1/HealthInfo;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/health/V2_1/HealthInfo;

    iget-object v3, p0, Landroid/hardware/health/V2_1/HealthInfo;->legacy:Landroid/hardware/health/V2_0/HealthInfo;

    iget-object v4, v2, Landroid/hardware/health/V2_1/HealthInfo;->legacy:Landroid/hardware/health/V2_0/HealthInfo;
    ...
    :cond_3
    iget v3, p0, Landroid/hardware/health/V2_1/HealthInfo;->batteryCapacityLevel:I

    iget v4, v2, Landroid/hardware/health/V2_1/HealthInfo;->batteryCapacityLevel:I
    ...
    :cond_4
    iget-wide v3, p0, Landroid/hardware/health/V2_1/HealthInfo;->batteryChargeTimeToFullNowSeconds:J

    iget-wide v5, v2, Landroid/hardware/health/V2_1/HealthInfo;->batteryChargeTimeToFullNowSeconds:J
    ...
    :cond_5
    iget v3, p0, Landroid/hardware/health/V2_1/HealthInfo;->batteryFullChargeDesignCapacityUah:I

    iget v4, v2, Landroid/hardware/health/V2_1/HealthInfo;->batteryFullChargeDesignCapacityUah:I
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget v2, p0, Landroid/hardware/health/V2_1/HealthInfo;->batteryFullChargeDesignCapacityUah:I
