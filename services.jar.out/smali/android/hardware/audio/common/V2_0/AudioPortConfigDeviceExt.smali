...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v5, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;

    invoke-direct {v5}, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;-><init>()V

    mul-int/lit8 v6, v4, 0x28

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v4, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;

    mul-int/lit8 v5, v3, 0x28

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;

    iget v3, p0, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->hwModule:I

    iget v4, v2, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->hwModule:I
    ...
    :cond_3
    iget v3, p0, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->type:I

    iget v4, v2, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->type:I
    ...
    :cond_4
    iget-object v3, p0, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->address:[B

    iget-object v4, v2, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->address:[B
...
.method public final hashCode()I
    ...
    iget-object v1, p0, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->address:[B
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object v2, p0, Landroid/hardware/audio/common/V2_0/AudioPortConfigDeviceExt;->address:[B
