...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/area/WindowAreaControllerImpl;->rearDisplayStatus()Lkotlinx/coroutines/flow/Flow;
.end annotation
...
# direct methods
.method public static synthetic $r8$lambda$W5Q7gWhbiQvDbku-1xnKHjOG9TU(Landroidx/window/area/WindowAreaControllerImpl;Lkotlinx/coroutines/channels/Channel;Ljava/lang/Integer;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->invokeSuspend$lambda-0(Landroidx/window/area/WindowAreaControllerImpl;Lkotlinx/coroutines/channels/Channel;Ljava/lang/Integer;)V
...
.method constructor <init>(Landroidx/window/area/WindowAreaControllerImpl;Lkotlin/coroutines/Continuation;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;",
            ">;)V"
        }
    .end annotation
...
.method private static final invokeSuspend$lambda-0(Landroidx/window/area/WindowAreaControllerImpl;Lkotlinx/coroutines/channels/Channel;Ljava/lang/Integer;)V
    .locals 2
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    invoke-direct {v0, p0, p2}, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;-><init>(Landroidx/window/area/WindowAreaControllerImpl;Lkotlin/coroutines/Continuation;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->invoke(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v5, v4, v1}, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1$$ExternalSyntheticLambda0;-><init>(Landroidx/window/area/WindowAreaControllerImpl;Lkotlinx/coroutines/channels/Channel;)V
    ...
    invoke-interface {v4, v5}, Landroidx/window/extensions/area/WindowAreaComponent;->addRearDisplayStatusListener(Ljava/util/function/Consumer;)V
    ...
    :goto_0
    :try_start_3
    iput-object p1, p0, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->L$0:Ljava/lang/Object;

    iput-object v4, p0, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->L$1:Ljava/lang/Object;

    iput-object v1, p0, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->L$2:Ljava/lang/Object;

    iput v3, p0, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->label:I
    ...
    iput-object v5, p0, Landroidx/window/area/WindowAreaControllerImpl$rearDisplayStatus$1;->L$0:Ljava/lang/Object;
    ...
    invoke-interface {p0, v4}, Landroidx/window/extensions/area/WindowAreaComponent;->removeRearDisplayStatusListener(Ljava/util/function/Consumer;)V
