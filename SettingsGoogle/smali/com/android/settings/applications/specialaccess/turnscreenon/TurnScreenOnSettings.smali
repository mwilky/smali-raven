...
.method public onResume()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings;->collectTurnScreenOnApps(I)Ljava/util/ArrayList;

    move-result-object v1

    new-instance v2, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings$AppComparator;

    iget-object v3, p0, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-direct {v2, v3}, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings$AppComparator;-><init>(Landroid/content/pm/PackageManager;)V
    ...
    iget-object v7, p0, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iget-object v9, p0, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings;->mIconDrawableFactory:Landroid/util/IconDrawableFactory;
    ...
    invoke-static {v3, v5, v6}, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnDetails;->getPreferenceSummary(Landroid/app/AppOpsManager;ILjava/lang/String;)I

    move-result v3

    invoke-virtual {v8, v3}, Landroidx/preference/Preference;->setSummary(I)V

    new-instance v3, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings$1;

    invoke-direct {v3, p0, v6, v4}, Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings$1;-><init>(Lcom/android/settings/applications/specialaccess/turnscreenon/TurnScreenOnSettings;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)V
