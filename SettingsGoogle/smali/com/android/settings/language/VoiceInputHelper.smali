...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/settings/language/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
...
.method public buildUi()V
    ...
    iget-object v2, p0, Lcom/android/settings/language/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    iput-object v2, p0, Lcom/android/settings/language/VoiceInputHelper;->mCurrentRecognizer:Landroid/content/ComponentName;

    goto :goto_0

    :cond_0
    iput-object v3, p0, Lcom/android/settings/language/VoiceInputHelper;->mCurrentRecognizer:Landroid/content/ComponentName;

    :goto_0
    iget-object v2, p0, Lcom/android/settings/language/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/settings/language/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
    ...
    :try_start_0
    iget-object v10, p0, Lcom/android/settings/language/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    :try_start_1
    iget-object v11, p0, Lcom/android/settings/language/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v13, "recognition-service"
    ...
    iget-object v8, p0, Lcom/android/settings/language/VoiceInputHelper;->mCurrentRecognizer:Landroid/content/ComponentName;
    ...
    :cond_5
    iget-object v7, p0, Lcom/android/settings/language/VoiceInputHelper;->mAvailableRecognizerInfos:Ljava/util/ArrayList;

    new-instance v8, Lcom/android/settings/language/VoiceInputHelper$RecognizerInfo;
    ...
    invoke-direct {v8, v10, v6, v11, v9}, Lcom/android/settings/language/VoiceInputHelper$RecognizerInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/content/pm/ServiceInfo;Ljava/lang/String;Z)V
